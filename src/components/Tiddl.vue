<template>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            When using Tiddl, your cat may at points lose interest in the process. Don’t try to control your cat's movement or increase the volume. If your cat loses interest, simply return to testing Tiddl with your cat later on. Several attempts may be required to attract and hold your cat’s attention. The object is to think about producing culture for cats, so any results at all are of use.
            ...
            Don’t introduce the cat to Tiddl or play its sounds while the cat is doing an important daily activity such as grooming, eating or using the litter box. There is a chance they may associate the sounds with the experience, leading to unexpected behavioral issues.
                </div>
        </div>
        <div class="col-md-6">
            <article class="panel">
                ...
                <p class="lead">tiddl is an application designed for cats and their companions. It contains a library of sounds that cat owners can select and play as ambient soundscapes for cats. The app was created as a pragmatic solution for boredom and depression that at any moment, up to 40% of domestic cats may experience.</p>
                    <ul class="list-group unstyled-list" >
                        ...
                        <div class="panel-body message-content" :class="{'is-collapsed' : collapsed1 }"> 
                            We created tiddl to assess your cat’s curiosity in a series of discrete and combined sounds. The sounds that can be looped in the app present a selection of natural sounds gathered from user research and testing with cats. We also included synthesized sounds based on research into producing music for cats.
                        Imagine crunching paper, running water, chimes in the wind, birds making a ruckus. We've got 32 sounds or over 200 combinations of soothing soundscapes for every cat mood! 
                        </div>

                        <li class="list-group-item panel-heading" @click="collapsed2 = !collapsed2">Infinite Looping</li>
                        ...
                        <li class="list-group-item panel-heading" @click="collapsed3 = !collapsed3">Away or At-home Play!</li>
