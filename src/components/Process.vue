<template>
    ...
    <section class="row d-flex">
        ...
        <p>We noticed a fair amount of pet products that were designed for human convenience and our aesthetic temperaments. Would you ever enjoy doing number 2 in an enclosed and dark space? 
            Would you like to sleep in a designer bed in the shape of your head, or drink from a fountain that looks like a flower?</p>

        <img src="@/assets/img/fountain.jpg">

        <p>To design for our feline friends, we did some user research on cat behaviour and preferences. Based on initial survey results, we made a <a href="https://youtu.be/byrcurs2ElI" target="_blank">Video for Cats</a> about other animals in captivity, we envisioned a Blue Planet type piece, but for cats.  
        You won’t believe what we found out! <i>The results were truly unastonishing</i>.
        </p>
        ...
        <img src="https://www.jotform.com/uploads/jensilver/81986809484274/4122294609919860818/IMG-1884.JPG">
        ...
        <br>In most cats the video appeared to activate feelings of observance, hunger, and predation.<br><br>
        A third of them preferred to sleep, groom themselves, or walked away.
        </p>
        <div class="inline"><p>Cat owners reported 41% of them responded to sounds more or as much. So we changed direction completely. Ben and Augie created <a href='#' v-on:mouseover="hover" v-on:mouseout="hoverOut">"species-appropriate"</a>, generated sounds. We started making a sound sampler.
        Jen watched a lot of cat-oriented YouTube playlists and conducted ethnographic interviews and surveys with cats. Cat (who is a cat owner, but not a cat) started mocking up designs and Jon compiled a simple app for us to test and iterate...with cats!</p> </div>
        <br><br> <span class="popover" v-if="showPopup3" transition="fade" v-on:mouseover="hoverInfo" v-on:mouseout="hoverOutInfo"><small>{{ notes[3].name }}</small></span>
        <p>And so <span id="appBrand">Tiddl</span> was born.</p>
...
export default {
    ...
    data () {
        return {
         ...
         quote : 'Our misunderstanding of cats as ‘low-maintenance’ pets has led to cats that are bored and stressed. This has resulted in an epidemic of feline obesity as well as stress-associated diseases',
         notes: [
